chain_weekly <- function(chr_underlying){
    ...
    df_expiration <-
        tibble::tibble(
            ...
            friday = seq(ymd(20131220), ymd(20181228), "weeks")
    ...
    # # removing troublesome dates, want to address this more thoroughly
    # df_expiration <-
    # df_expiration %>% 
    #     dplyr::filter(expiration != lubridate::ymd(20150402)) %>% 
    #     dplyr::filter(expiration != lubridate::ymd(20151218))
