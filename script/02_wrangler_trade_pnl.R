...
df_chain_hist <- 
    read_csv(
        "data_output/dia_weekly_2014_2018_chain_hist.csv"
        , col_types = cols()
    )

df_opt_hist <-
    read_csv(
        "data_output/dia_weekly_2014_2018_opt_hist.csv"
        , col_types = cols()
    )

df_underlying  <- tibble(underlying = c("DIA"))
...
##########################
#write_csv(df_pnl, "dia_weekly_2014_2018_pnl_master.csv")
#write_csv(df_trade, "dia_weekly_2014_2018_trade_master.csv")
